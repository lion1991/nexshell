...
use crate::util::bindings::{KeybindingChangedEvent, KeybindingChangedNotifier};

/// 本地化自 terminal::input —— ActionButton tooltip 定位只需这两个最小定义。
...
impl ButtonSize {
    ...
    fn button_horizontal_padding(&self) -> f32 {
        match self {
            ...
            ButtonSize::UDIPromptChip | ButtonSize::AgentInputButton => 4.0,
        }
    }
