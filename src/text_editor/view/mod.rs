...
impl EditorView {
    ...
    pub fn set_is_password(&mut self, is_password: bool) {
...
impl View for EditorView {
    ...
    fn render(&self, ctx: &AppContext) -> Box<dyn Element> {
        ...
        #[cfg(feature = "voice_input")]
        let voice_input_toggle_key_code = self
            .voice_transcription_options
            .is_enabled()
            .then(|| self.voice_input_toggle_key_code(ctx))
            .flatten();
        #[cfg(not(feature = "voice_input"))]
        let voice_input_toggle_key_code = None;
