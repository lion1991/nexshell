//! 摘自 warp app settings_view::flags — text_editor keymap context 标识符常量。
//! 放 lib crate（text_editor 所在），binary settings_view 够不着原 binary 副本。
...
pub const TERMINAL_INPUT_PAGE_KEYS_HANDLED_BY_INPUT: &str = "TerminalInputPageKeysHandledByInput";
